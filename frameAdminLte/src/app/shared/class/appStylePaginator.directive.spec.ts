...
import { StylePaginatorDirective } from './appStylePaginator.directive';
...
function createComponent<T>(type: Type<T>, providers: Provider[] = []): ComponentFixture<T> {
  TestBed.configureTestingModule({
    ...
    declarations: [type, StylePaginatorDirective],
...
function getElementByText(paginatorElement: HTMLElement, type: string, text: string): Element | undefined {
  return Array.from(paginatorElement.querySelectorAll(type))
