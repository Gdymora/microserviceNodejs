...
@Directive({
    selector: '[appStyleButtonnPaginator]',
})
export class StylePaginatorButtonDirective implements AfterViewInit, DoCheck {
    ...
    private buildPageNumbers(pageCount, pageRange): void  {
        let dots = false;
